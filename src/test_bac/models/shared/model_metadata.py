...
import dataclasses
from ..shared import model_jobrequester as shared_model_jobrequester
...
class ModelMetadata:
    ...
    requester: Optional[shared_model_jobrequester.ModelJobRequester] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Requester'), 'exclude': lambda f: f is None }})
