...
import dataclasses
from ..shared import publicapi_eventfilteroptions as shared_publicapi_eventfilteroptions
...
class PublicapiEventsRequest:
    ...
    filters: Optional[shared_publicapi_eventfilteroptions.PublicapiEventFilterOptions] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filters'), 'exclude': lambda f: f is None }})
