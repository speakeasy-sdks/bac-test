...
import dataclasses
from ..shared import model_jobcancelpayload as shared_model_jobcancelpayload
...
class PublicapiCancelRequest:
    ...
    payload: shared_model_jobcancelpayload.ModelJobCancelPayload = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('payload') }})
