...
import dataclasses
from ..shared import model_executionstate as shared_model_executionstate
...
class ModelJobState:
    ...
    executions: Optional[list[shared_model_executionstate.ModelExecutionState]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Executions'), 'exclude': lambda f: f is None }})
    ...
    state: Optional[shared_model_jobstatetype.ModelJobStateType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('State'), 'exclude': lambda f: f is None }})
