...
import dataclasses
from ..shared import model_s3storagespec as shared_model_s3storagespec
...
class ModelStorageSpec:
    ...
    s3: Optional[shared_model_s3storagespec.ModelS3StorageSpec] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('S3'), 'exclude': lambda f: f is None }})
    ...
    storage_source: Optional[shared_model_storagesourcetype.ModelStorageSourceType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('StorageSource'), 'exclude': lambda f: f is None }})
