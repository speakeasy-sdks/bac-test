...
import dataclasses
from ..shared import model_jobcreatepayload as shared_model_jobcreatepayload
...
class PublicapiSubmitRequest:
    ...
    payload: shared_model_jobcreatepayload.ModelJobCreatePayload = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('payload') }})
