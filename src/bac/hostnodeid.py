...
class HostNodeID:
    ...
    def get(self) -> operations.GetHostNodeIDResponse:
        ...
        hook_ctx = HookContext(operation_id='getHostNodeId', oauth2_scopes=[], security_source=None)
        ...
        res = operations.GetHostNodeIDResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
