...
class Nodes:
    ...
    def display(self) -> operations.DisplayNodesResponse:
        ...
        hook_ctx = HookContext(operation_id='displayNodes', oauth2_scopes=[], security_source=None)
        ...
        res = operations.DisplayNodesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
