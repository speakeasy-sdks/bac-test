...
class JobEvents:
    ...
    def get(self, request: shared.EventsRequest) -> operations.GetJobEventsResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getJobEvents', oauth2_scopes=[], security_source=None)
        ...
        req_content_type, data, form = utils.serialize_request_body(request, shared.EventsRequest, "request", False, False, 'json')
        ...
        res = operations.GetJobEventsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(http_res.headers.get('Content-Type'), 'application/json'):                
                out = utils.unmarshal_json(http_res.text, Optional[shared.EventsResponse])
                res.events_response = out
            else:
