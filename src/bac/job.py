...
class Job:
    ...
    def approve(self) -> operations.ApproveJobResponse:
        ...
        res = operations.ApproveJobResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def submit(self, request: shared.SubmitRequest) -> operations.SubmitJobResponse:
        ...
        * `payload`:
        ...
        res = operations.SubmitJobResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
