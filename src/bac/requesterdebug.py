...
class RequesterDebug:
    ...
    def get(self) -> operations.GetRequesterDebugResponse:
        ...
        hook_ctx = HookContext(operation_id='getRequesterDebug', oauth2_scopes=[], security_source=None)
        ...
        res = operations.GetRequesterDebugResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
