...
import dataclasses
from ..shared import jobcreatepayload as shared_jobcreatepayload
...
class SubmitRequest:
    ...
    payload: shared_jobcreatepayload.JobCreatePayload = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('payload') }})
