...
class Livez:
    ...
    def get(self) -> operations.GetLivezResponse:
        hook_ctx = HookContext(operation_id='getLivez', oauth2_scopes=[], security_source=None)
        ...
        res = operations.GetLivezResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
