...
class Debug:
    ...
    def get(self) -> operations.GetDebugResponse:
        r"""Returns debug information on what the current node is doing."""
        hook_ctx = HookContext(operation_id='getDebug', oauth2_scopes=[], security_source=None)
        ...
        res = operations.GetDebugResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
