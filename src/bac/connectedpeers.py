...
class ConnectedPeers:
    ...
    def get(self) -> operations.GetConnectedPeersResponse:
        ...
        ```
        """
        hook_ctx = HookContext(operation_id='getConnectedPeers', oauth2_scopes=[], security_source=None)
        ...
        res = operations.GetConnectedPeersResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
